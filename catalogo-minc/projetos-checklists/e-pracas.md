...
## Básico
- Projeto: **e-pracas**
- Repositório: [gitHub](https://github.com/culturagovbr/e-pracas)
...
- [ ] Já aceitou algum pull request?
  ...
  - Número de forks: 1
  - Utiliza a wiki? Não
- [x] A "fila" de issues está atualizada ? Não, últimas atualizações em 2015/2016
...
## Automação
- Gerenciador de tarefas (make, rake, inv, gulp, etc): gulp, yarn
